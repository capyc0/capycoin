Contributing to Capybara Coin Core
============================

The Capybara Coin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/capyc0/capycoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Capybara Coin Core project, and is not to be
confused with overall Capybara Coin Network Protocol consensus changes.

Whether a pull request is merged into Capybara Coin Core rests with the project merge
...
Patches that change Capybara Coin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Capybara Coin consensus, it must have been
...
The project leader is the release manager for each Capybara Coin Core release.
