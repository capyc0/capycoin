...
cap.conf           | contains configuration settings for capd or cap-qt
capd.pid           | stores the process id of capd while running
...
debug.log           | contains debug information and general logging generated by capd or cap-qt
