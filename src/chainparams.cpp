...
{
    const char* pszTimestamp = "The Capy Experience: Where Chill Meets Speed! 🦫🏎";
    const CScript genesisOutputScript = CScript() << ParseHex("04c473fc84bcfc964001ed17a92e89bc65ddbd8d10533651694fce303970b50a3981e648c801298e8ec001ac3ec3207ea2baaa1fe000a41010912a31aa988c0d8a") << OP_CHECKSIG;
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1744376320, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        //  uint32_t nGenesisTime = 1744376320;
        //  arith_uint256 test;
        //  bool fNegative;
        //  bool fOverflow;
        ...
        genesis = CreateGenesisBlock(1744376320, 1241468, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000f87f4c02d86ea65d0f90e1468ba94edfd43164f149c89b870e470d6002c"));
        assert(genesis.hashMerkleRoot == uint256S("0x321ea737b62eb441166dd0d9d7aef49e2a69c9a593c0063ef945ee12367c997f"));
        ...
        // spork keys
        consensus.strSporkPubKey = "047a04fee76bd98be05fe3909e56b13d75c7ee631e41cf910c6e0ef021a40866705af98baff35412d1fb7504aa4d999a8f60ea6c1476c6e9776314f04c71973fc1";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;

        // dev address
        consensus.devAddress = "CHoPt9asGT6vrpc84VmAm1Zfodjd1JwLFp";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.capcoin.online"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.capcoin.online"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.capcoin.online"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.capcoin.online"));
	    vSeeds.push_back(CDNSSeedData("seed5", "seed5.capcoin.online"));
	    vSeeds.push_back(CDNSSeedData("seed6", "seed6.capcoin.online"));
	    vSeeds.push_back(CDNSSeedData("seed7", "seed7.capcoin.online"));
	    vSeeds.push_back(CDNSSeedData("seed8", "seed8.capcoin.online"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 56);     // P
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // cap starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet cap addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 66);  // Testnet cap script addresses start with 'T'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet cap BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet cap BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet cap BIP44 coin type is '1' (All coin's testnet default)
