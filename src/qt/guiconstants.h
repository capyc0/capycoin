...
/* Capybara Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Capybara Coin"
#define QAPP_ORG_DOMAIN "capcoin.online"
#define QAPP_APP_NAME_DEFAULT "CapybaraCoin-Qt"
#define QAPP_APP_NAME_TESTNET "CapybaraCoin-Qt-testnet"
