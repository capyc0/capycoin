...
/** Utility functions used by the Capybara Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render CAP addresses in monospace font
...
// Parse "cap:" URI into recipient object, return true on successful parsing
