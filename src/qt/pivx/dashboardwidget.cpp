    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of CAP earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 CAP");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair CAP, zDDR
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(215, 148, 79));
	set1->setColor(QColor(149, 224, 223));
