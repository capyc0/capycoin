...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CAP features */
        {"cap", "listmasternodes", &listmasternodes, true },
        {"cap", "getmasternodecount", &getmasternodecount, true },
        {"cap", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"cap", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"cap", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"cap", "masternodecurrent", &masternodecurrent, true },
        {"cap", "startmasternode", &startmasternode, true },
        {"cap", "createmasternodekey", &createmasternodekey, true },
        {"cap", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"cap", "listmasternodeconf", &listmasternodeconf, true },
        {"cap", "getmasternodestatus", &getmasternodestatus, true },
        {"cap", "getmasternodewinners", &getmasternodewinners, true },
        {"cap", "getmasternodescores", &getmasternodescores, true },
        {"cap", "preparebudget", &preparebudget, true },
        {"cap", "submitbudget", &submitbudget, true },
        {"cap", "mnbudgetvote", &mnbudgetvote, true },
        {"cap", "getbudgetvotes", &getbudgetvotes, true },
        {"cap", "getnextsuperblock", &getnextsuperblock, true },
        {"cap", "getbudgetprojection", &getbudgetprojection, true },
        {"cap", "getbudgetinfo", &getbudgetinfo, true },
        {"cap", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"cap", "mnfinalbudget", &mnfinalbudget, true },
        {"cap", "checkbudgets", &checkbudgets, true },
        {"cap", "mnsync", &mnsync, true },
        {"cap", "spork", &spork, true },
        {"cap", "getcollateral", &getcollateral, true},
...
{
    return "> cap-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:54830/\n";
}
