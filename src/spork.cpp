...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_20_DEVELOPER_PAYMENT_ENFORCEMENT, 4070908800ULL), // OFF
...
// Capybara Coin: on startup load spork values from previous session if they exist in the sporkDB
...
void CSporkManager::ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == NetMsgType::SPORK) {
        ...
        // Capybara Coin: add to spork database.
