...
"""Verify that starting cap with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cap with -? for help text")
        ...
        self.log.info("Start cap with -version for version information")
